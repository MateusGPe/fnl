...
public:
    ...
    void on_open_image()
    {
        ...
        if (chooser.show())
        {
            load_image(chooser.filename(), 0, 0);
        }
    }

    void on_quit() { m_win->hide(); }
    void on_reset_view() { m_viewer->reset_view(); }
    void on_fit_all() { m_viewer->fit_all(); }
    void on_center_all() { m_viewer->center_all(); }
    void on_fit_to_canvas() { m_viewer->fit_to_canvas(); }
    ...
    void on_tool_select() { set_tool(0); }
    void on_tool_pan() { set_tool(1); }
    void on_tool_move() { set_tool(2); }
    void on_tool_crop() { set_tool(3); }
    void on_tool_eye() { set_tool(4); }
    ...
    {
        Fl_Menu_Item menu[] = {
            {"Bring Forward", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_layer_up(); }, this},
            {"Send Backward", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_layer_down(); }, this, FL_MENU_DIVIDER},
            {"Group to Below Layer", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_group_layer(); }, this},
            {"Ungroup Layer", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_ungroup_layer(); }, this, FL_MENU_DIVIDER},
            {"Toggle Visibility", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_layer_toggle_vis(); }, this},
            {"Toggle Lock", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_layer_toggle_lock(); }, this, FL_MENU_DIVIDER},
            {"Delete Layer", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_layer_delete(); }, this, FL_MENU_DIVIDER},
            {"Flip Horizontal", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_flip_h(); }, this},
            {"Flip Vertical", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_flip_v(); }, this},
            {"Rotate 90 Degrees", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_rot_90(); }, this, FL_MENU_DIVIDER},
            {"Reset View (100%)", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_reset_view(); }, this},
            {"Fit All", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_fit_all(); }, this},
            {"Center All", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_center_all(); }, this},
            {"Fit to Canvas", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_fit_to_canvas(); }, this},
            {"Export Image...", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_export_image(); }, this},
            {"Export JSON to Console", 0, [](Fl_Widget *, void *v)
             { static_cast<ImageViewerApp *>(v)->on_export_json(); }, this},
            {0}};
    ...
    void build_ui()
    {
        ...
        m_tool_choice_handle->callback([](Fl_Widget *, void *v)
                                       { static_cast<ImageViewerApp *>(v)->on_tool_changed(); }, this);
        sy += 35;

        mui::Button *fit_btn = new mui::Button(sx, sy, 70, 25, "Fit All");
        fit_btn->callback([](Fl_Widget *, void *v)
                          { static_cast<ImageViewerApp *>(v)->on_fit_all(); }, this);

        mui::Button *reset_btn = new mui::Button(sx + 75, sy, 70, 25, "100%");
        reset_btn->callback([](Fl_Widget *, void *v)
                            { static_cast<ImageViewerApp *>(v)->on_reset_view(); }, this);

        m_minimap_btn_handle = new mui::LightButton(sx + 150, sy, sw - 150, 25, "Minimap");
        m_minimap_btn_handle->value(m_viewer->show_minimap());
        m_minimap_btn_handle->callback([](Fl_Widget *, void *v)
                                       { static_cast<ImageViewerApp *>(v)->on_toggle_minimap(); }, this);
        sy += 35;

        mui::Button *grid_btn = new mui::Button(sx, sy, 100, 25, "Toggle Grid");
        grid_btn->callback([](Fl_Widget *, void *v)
                           { static_cast<ImageViewerApp *>(v)->on_toggle_grid(); }, this);
        ...
        m_grid_size_slider_handle->callback([](Fl_Widget *, void *v)
                                            { static_cast<ImageViewerApp *>(v)->on_grid_size_changed(); }, this);
        sy += 35;
        ...
        m_canvas_mode_choice_handle->callback([](Fl_Widget *, void *v)
                                              { static_cast<ImageViewerApp *>(v)->on_canvas_mode_changed(); }, this);
        sy += 35;
        ...
        m_canvas_h_spinner_handle->callback([](Fl_Widget *, void *v)
                                            { static_cast<ImageViewerApp *>(v)->on_canvas_size_changed(); }, this);
        sy += 35;

        mui::Button *undo_btn = new mui::Button(sx, sy, sw / 2 - 2, 25, "Undo");
        undo_btn->callback([](Fl_Widget *, void *v)
                           { static_cast<ImageViewerApp *>(v)->on_undo(); }, this);
        mui::Button *redo_btn = new mui::Button(sx + sw / 2 + 2, sy, sw / 2 - 2, 25, "Redo");
        redo_btn->callback([](Fl_Widget *, void *v)
                           { static_cast<ImageViewerApp *>(v)->on_redo(); }, this);
        sy += 35;
        ...
        up_btn->callback([](Fl_Widget *, void *v)
                         { static_cast<ImageViewerApp *>(v)->on_layer_up(); }, this);
        mui::Button *down_btn = new mui::Button(sx + btn_w + 2, sy, btn_w, 25, "Down");
        down_btn->callback([](Fl_Widget *, void *v)
                           { static_cast<ImageViewerApp *>(v)->on_layer_down(); }, this);
        mui::Button *group_btn = new mui::Button(sx + 2 * (btn_w + 2), sy, btn_w, 25, "Group");
        group_btn->callback([](Fl_Widget *, void *v)
                            { static_cast<ImageViewerApp *>(v)->on_group_layer(); }, this);
        mui::Button *ungroup_btn = new mui::Button(sx + 3 * (btn_w + 2), sy, btn_w, 25, "Ungroup");
        ungroup_btn->callback([](Fl_Widget *, void *v)
                              { static_cast<ImageViewerApp *>(v)->on_ungroup_layer(); }, this);
        sy += 30;

        m_layer_list = new LayerBrowser(sx, sy, sw, 200);
        m_layer_list->callback([](Fl_Widget *, void *v)
                               { static_cast<ImageViewerApp *>(v)->on_browser_select(); }, this);
        sy += 205;
        ...
        m_opacity_slider_handle->callback([](Fl_Widget *, void *v)
                                          { static_cast<ImageViewerApp *>(v)->on_opacity_changed(); }, this);
        sy += 35;

        mui::Button *flip_h_btn = new mui::Button(sx, sy, btn_w, 25, "Flip H");
        flip_h_btn->callback([](Fl_Widget *, void *v)
                             { static_cast<ImageViewerApp *>(v)->on_flip_h(); }, this);
        mui::Button *flip_v_btn = new mui::Button(sx + btn_w + 2, sy, btn_w, 25, "Flip V");
        flip_v_btn->callback([](Fl_Widget *, void *v)
                             { static_cast<ImageViewerApp *>(v)->on_flip_v(); }, this);
        mui::Button *rot_90_btn = new mui::Button(sx + 2 * (btn_w + 2), sy, btn_w, 25, "Rot 90");
        rot_90_btn->callback([](Fl_Widget *, void *v)
                             { static_cast<ImageViewerApp *>(v)->on_rot_90(); }, this);
        sy += 35;
        ...
        m_rot_slider_handle->callback([](Fl_Widget *, void *v)
                                      { static_cast<ImageViewerApp *>(v)->on_rot_changed(); }, this);
        sy += 35;

        mui::Button *hide_btn = new mui::Button(sx, sy, btn_w, 25, "Hide");
        hide_btn->callback([](Fl_Widget *, void *v)
                           { static_cast<ImageViewerApp *>(v)->on_layer_toggle_vis(); }, this);
        mui::Button *lock_btn = new mui::Button(sx + btn_w + 2, sy, btn_w, 25, "Lock");
        lock_btn->callback([](Fl_Widget *, void *v)
                           { static_cast<ImageViewerApp *>(v)->on_layer_toggle_lock(); }, this);
        mui::Button *del_btn = new mui::Button(sx + 2 * (btn_w + 2), sy, btn_w, 25, "Del");
        del_btn->callback([](Fl_Widget *, void *v)
                          { static_cast<ImageViewerApp *>(v)->on_layer_delete(); }, this);
        mui::Button *clear_btn = new mui::Button(sx + 3 * (btn_w + 2), sy, btn_w, 25, "Clear");
        clear_btn->callback([](Fl_Widget *, void *v)
                            { static_cast<ImageViewerApp *>(v)->on_clear_layers(); }, this);
